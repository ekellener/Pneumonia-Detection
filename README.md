...
# Data 
Download chestXray data from [here](https://data.mendeley.com/datasets/rscbjbr9sj/2) to chest-xray folder
 ...
 **Generating Heat Map:** 
    ...
    python heatmap.py --model_path=runs/debug/chexnet_0.01_5 --inp_img_pth='chest-xray/test/PNEUMONIA/person59_virus_116.jpeg' --out_img_pth='heatmap.png'
